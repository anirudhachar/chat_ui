...
const mockMessagesMap: { [key: string]: Message[] } = {
  ...
  '2': [
    { id: '1', content: 'I need some help with the project', timestamp: 'Yesterday', sent: false, type: 'text' },
    { id: '2', content: 'Sure! What do you need?', timestamp: 'Yesterday', sent: true, type: 'text', status: 'read' },
    { id: '3', content: 'Thanks for the help!', timestamp: 'Yesterday', sent: false, type: 'text' },
  ],
  '3': [
    { id: '1', content: 'Let\'s meet tomorrow!', timestamp: '2 days ago', sent: true, type: 'text', status: 'delivered' },
    { id: '2', content: 'See you tomorrow 👋', timestamp: '2 days ago', sent: false, type: 'text' },
  ],
};
...
export default function ChatInterface() {
  ...
  const handleUserSelect = (user: User) => {
    ...
    setUsers(users.map(u => 
      u.id === user.id ? { ...u, unread: undefined } : u
    ));
  ...
  const handleSendMessage = (content: string, type: 'text' | 'image' | 'document' = 'text', file?: { name: string; url: string }) => {
